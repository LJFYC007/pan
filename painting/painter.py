...
delta_x = 400 - 1 # set to move the picture
delta_y = 100 - 2 # real_x = gived_x + delta_x
...
def get_board():
	request = requests_get('https://www.luogu.com.cn/paintBoard/board')
...
def paint(x, y, color):
	...
	request = requests_post('https://www.luogu.com.cn/paintBoard/paint', data)
